...
// @mui
import { Box, Button, Stack, Dialog, DialogTitle, DialogContent, IconButton, InputAdornment } from '@mui/material';
// hooks
  ...
  return (
    <>
      <Dialog fullWidth maxWidth="xs" open={open} onClose={handleClose}>
        ...
        <DialogTitle sx={{ pb: 2, textAlign: 'center' }}>{t('change_password')}</DialogTitle>
