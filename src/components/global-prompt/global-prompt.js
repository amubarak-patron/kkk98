      ...
      {prompts.map((prompt) => {
        ...
        return (
          ...
          >
            ...
            {GlobalPrompt.title && (
              <DialogTitle sx={{ pb: 2, textAlign: 'center' }}>{GlobalPrompt.title}</DialogTitle>
            )}
            ...
            {GlobalPrompt.content && (
              ...
              >
                ...
                >
                  {['', 'warning'].includes(GlobalPrompt?.promptProps?.icon) && (
                    <Iconify
                  ...
                  {GlobalPrompt?.promptProps?.icon === 'success' && (
                    <Iconify icon="mdi:check-circle" color="success.main" width={92} height={92} />
                  )}
                  {GlobalPrompt?.promptProps?.icon === 'error' && (
                    <Iconify icon="mdi:close-circle" color="error.main" width={92} height={92} />
                  )}
                </Box>
