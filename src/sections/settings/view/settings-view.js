...
import ChangePasswordPanel from '../panels/change-password-panel';
import AppearancePanel from '../panels/appearance_panel';
import MyAccountPanel from '../panels/my-account-panel';
...
export default function SettingsView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      <Card>
        <SettingsTabs tabs={tabs.tabs} handleChange={handleChangeTab} value={tabs.currentTab} />
      </Card>
